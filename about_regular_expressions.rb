...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # For example, ab*c will fail to match azc, since b* will not match z and c will not match zc.
  end
  ...
  def test_scan_is_like_find_all
    ...
    #The match method returns the first item in your string that 
    #matches a given Regular Expression as a MatchData object.
